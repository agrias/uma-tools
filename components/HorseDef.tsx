...
export function UmaSelector(props) {
	const randomMob = useMemo(() => `/assets/mob/trained_mob_chr_icon_${8000 + Math.floor(Math.random() * 624)}_000001_01.png`, []);
	...
	return (
		<div class="umaSelector">
			<div class="umaSelectorIconsBox" onClick={focus}>
				...
				<img src="/assets/utx_ico_umamusume_00.png" />
			</div>
...
export function Stat(props) {
	return (
		<div class="horseParam">
			<img src={`/assets/statusrank/ui_statusrank_${(100 + rankForStat(props.value)).toString().slice(1)}.png`} />
...
export function AptitudeIcon(props) {
	...
	return <img src={`/assets/utx_ico_statusrank_${(100 + idx).toString().slice(1)}.png`} />;
}
	...
	return (
		<div class="horseDef">
			...
			<div class="horseParams">
				<div class="horseParamHeader"><img src="/assets/status_00.png" /><span>Speed</span></div>
				<div class="horseParamHeader"><img src="/assets/status_01.png" /><span>Stamina</span></div>
				<div class="horseParamHeader"><img src="/assets/status_02.png" /><span>Power</span></div>
				<div class="horseParamHeader"><img src="/assets/status_03.png" /><span>Guts</span></div>
				<div class="horseParamHeader"><img src="/assets/status_04.png" /><span>{CC_GLOBAL?'Wit':'Wisdom'}</span></div>
